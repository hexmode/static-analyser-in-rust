...
The =Driver= contains a =CodeMap= and various other configuration
...
He has various methods to allow users to add files to be analysed, as
well as other convenience methods for setting things up.
